...
def analyze_federated_task_processing_time_results():
    ...
    file_str = f"results/saved_results/federated_{federated_rounds}_rounds_processing_time_comp.txt"
    ...
    # print(tmp_list)
    # 2. 保存图片
    output_path = f"pic/federated_comp/federated_avg_task_processing_time_{federated_rounds}_rounds.png"
