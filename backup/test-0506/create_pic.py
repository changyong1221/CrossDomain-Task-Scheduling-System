...
def plot_data_loss():
    data = pd.read_csv("D3QN-OPT4/test/loss.txt", header=None)
    data.columns = ['loss']
    ...
    # plt.legend(loc='best')
    # 保存图片
    plt.savefig(f"D3QN-OPT4/test/testing_loss.png")
    # 展示折线图
    # plt.show()

def plot_data_reward():
    data = pd.read_csv("D3QN-OPT4/test/reward.txt", header=None)
    data.columns = ['reward']
    ...
    # plt.legend(loc='best')
    # 保存图片
    plt.savefig(f"D3QN-OPT4/test/testing_reward_3.png")
    # 展示折线图
    # plt.show()

def plot_data_q_value():
    data = pd.read_csv("D3QN-OPT4/test/q_value.txt", header=None)
    ...
    # plt.legend(loc='best')
    # 保存图片
    plt.savefig(f"D3QN-OPT4/test/testing_q_value.png")
    # 展示折线图
    # plt.show()

def plot_action():
    data = pd.read_csv("D3QN-OPT4/test/action.txt", header=None, delimiter='\t')
    ...
    # plt.legend(loc='best')
    # 保存图片
    plt.savefig(f"D3QN-OPT4/test/testing_action.png")
    # 展示折线图
    # plt.show()
